  ...
  <div>
    ...
    {internships.map((intern, idx) => (
      ...
      >
        ...
        <div>
          <h4 className="text-xl font-bold text-gray-200 dark:text-gray-800">{intern.role}</h4>
          <p className="text-gray-300 dark:text-gray-600">{intern.company}</p>
          <p className="text-gray-300 dark:text-gray-600 text-sm italic">{intern.duration}</p>
          <p className="text-gray-300 dark:text-gray-600 mt-2">{intern.description}</p>
        </div>
      </div>
    ))}
  </div>
