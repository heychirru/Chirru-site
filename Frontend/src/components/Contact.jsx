...
const redirectToInstagram = () =>
  window.open("https://www.instagram.com/chir.ru_26t/?igsh=MTh3YWJ3eTY3eHNhdA==", "_blank", "noopener,noreferrer");

const redirectToFacebook = () =>
  window.open("https://www.facebook.com/chirru26/", "_blank", "noopener,noreferrer");

const redirectToLinkedIn = () =>
  window.open("https://www.linkedin.com/in/heychirru26?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", "_blank", "noopener,noreferrer");
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                <a href="#" className="text-blue-500 hover:underline" onClick={redirectToGmail}>
                  chirru26@gmail.com
                </a>
              </p>
            </div>
            <div>
              ...
              <div className="flex gap-3 text-2xl transition-all mt-5">
                <FaFacebook className="text-blue-400 cursor-pointer" onClick={redirectToFacebook} />
                <FaInstagram className="text-blue-400 cursor-pointer" onClick={redirectToInstagram} />
                <FaLinkedin className="text-blue-400 cursor-pointer" onClick={redirectToLinkedIn} />
                <FaSquareXTwitter className="text-blue-400 cursor-pointer" onClick={redirectToTwitter} />
              </div>
            </div>
          </div>
